...
const ilDatepickerCss = "@import url(\"https://fonts.googleapis.com/css2?family=Karla:wght@200;300;400;500;600;700;800&display=swap\"); *{margin:0;padding:0;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}.il-input .date-control .input-field{border-top-right-radius:unset;border-bottom-right-radius:unset}.il-input .date-control .date-field{width:46px;background:#4caf50;border-top-left-radius:unset;border-bottom-left-radius:unset}";

const IlDatepicker = class {
  constructor(hostRef) {
  ...
  render() {
    return (h("div", { class: "il-input" }, h("p", null, h("span", { class: "label" }, this.label, this.required ? h("span", { class: "il-required" }, "*") : null), this.tooltip ? h("il-tooltip", { tooltip: this.tooltip }) : null), h("div", { class: "input-control date-control" }, h("input", Object.assign({ type: "text", class: "il-control input-field", value: this.value, placeholder: this.placeholder, onInput: this.onInputFieldChangeValue.bind(this) }, (this.readOnly && { disabled: true }))), h("input", Object.assign({ class: "il-control date-field", type: "date", value: format(new Date(this.value), "yyyy-MM-dd"), placeholder: this.placeholder,
      // onBlur={this.onInputBlurValue.bind(this)}
      onInput: this.onInputChangeValue.bind(this) }, (this.readOnly && { disabled: true })))), this.error ? h("p", { class: "il-error" }, this.error) : null));
  }
};
IlDatepicker.style = ilDatepickerCss;

export { IlDatepicker as il_datepicker };

//# sourceMappingURL=il-datepicker.entry.js.map